...
CUDA's own dynamic memory allocator, cuMalloc, is kept as an alternative, easily selectable before running TensorFlow. It is however composed of proprietary code and does not share anything else but the header file that allows it to be used. % As such, we cannot say what type of allocator cuMalloc is -- as different allocator algorithms can be categorized in different types.
